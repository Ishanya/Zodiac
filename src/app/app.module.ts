...
import {MatButtonModule, MatCheckboxModule, MatAutocompleteModule, 
  ...
  MatToolbarModule, MatIconModule, MatMenuTrigger, MatMenuModule, MatCardModule, MatSpinner, MatProgressSpinner, MatProgressSpinnerModule, MatDatepickerModule, MatNativeDateModule, MatRadioModule, MatSelectModule, MatTableDataSource, MatTableModule, MatPaginatorModule, MatSnackBarModule} from '@angular/material';
...
import { PlayItemListComponent } from './play-item-list/play-item-list.component';
...
@NgModule({
  ...
  providers: [AdminserviceService,UserserviceService,MovieserviceService,UserserviceService],
